...
public class Q1
{
    ...
    private static final double Ne = 25;
...
//        for(int i =0; i < 100; i++)
        ...
        while (true)
        {
            ...
            {
//            	numSteps = (i)* 2000 + loop;
//                double alpha = 60.0 / (59 + loop) * 1.0;
//                double alpha = 60.0 / (59 + numSteps) * 1.0;
                ...
                double alpha = 60.0 / (59 + (n_val+1)) * 1.0;
...
//                System.out.println("State : " + i + " , " + j + "   Max Utility :  " + max_val + "   Policy  :  " + states[i][j].policy);
    ...
    public void plotGraph(){
		  ...
		  plot.setFixedBounds(0, 0, utilityVals.size());
		  plot.setFixedBounds(1, 0, 110);
		  plot.setAxisLabels("Number of Iterations", "Utility Values");
//		  plot.setBounds(0, 0, 13000, 150);
		  // put the PlotPanel in a JFrame, as a JPanel
		  JFrame frame = new JFrame("Q Learning Iteration");
...
//        System.out.println("utilityVals size == numIters "+utilityVals.size());
//        System.out.println("Num States "+ (utilityVals.get(0).size()));
//        System.out.println("rmseSize "+rmseToPlot.size());
//        obj.plotGraph();
//        obj.plotRMSE();
    }
